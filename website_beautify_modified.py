        ...
        for i in range(0, len(chapter)):
            ...
            for j in range(0, len(section)):
                ...
                for k in range(len(video_entete)):
                    ...
                    <div class="card card-body">
                    <video class="HTMLvideo" src="http://botafogo.saitis.net/analyse-1/videos/{video_url}" poster="http://botafogo.saitis.net/analyse-1/videos/{video_thumbnail}" controls=true></video>
                    </div>
                    </div>
                    </div>
                    """
